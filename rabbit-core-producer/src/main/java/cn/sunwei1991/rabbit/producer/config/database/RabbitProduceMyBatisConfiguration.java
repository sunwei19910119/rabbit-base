...
/**
 * @Title RabbitProduceMyBatisConfiguration
 * @Description
 * @Author SunWei
...
public class RabbitProduceMyBatisConfiguration {
    ...
    public SqlSessionFactory rabbitProducerSqlSessionFactory(DataSource rabbitProducerDataSource){
        ...
        try {
            ...
            bean.setMapperLocations(resolver.getResources(CLASSPATH_ALL_URL_PREFIX + "cn/sunwei1991/rabbit/producer/mapping/*.xml"));
