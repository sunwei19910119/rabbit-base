package cn.sunwei1991.rabbit.task.parser;
...
import cn.sunwei1991.rabbit.task.autoconfigure.ElasticJobZookeeperProperties;
...
/**
 * @Title ElasticJobConfigParser
 * @Description 自定义注解解析器
 * @Author SunWei
 * @Create 2020/10/23 2:17 下午
 */
public class ElasticJobConfigParser implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent applicationReadyEvent) {
        ...
        try {
            ...
            for (Iterator<?> iterator = beansWithAnnotation.values().iterator(); iterator.hasNext(); ) {
                 ...
                 * 一级配置
                 */
                cn.sunwei1991.rabbit.task.annotaion.JobCoreConfiguration jobCoreConfiguration = annotation.coreConfig();
                 ...
                 * 三级配置
                 */
                cn.sunwei1991.rabbit.task.annotaion.LiteJobConfiguration liteJobConfiguration = annotation.liteJobConfig();
    ...
    private JobCoreConfiguration getJobCoreConfiguration(cn.sunwei1991.rabbit.task.annotaion.JobCoreConfiguration jobCoreConfiguration){
    ...
    private LiteJobConfiguration getLiteJobConfiguration(cn.sunwei1991.rabbit.task.annotaion.LiteJobConfiguration liteJobConfiguration
    ...
    private List<BeanDefinition> getTargetElasticJobListeners(cn.sunwei1991.rabbit.task.annotaion.ListenerConfiguration listenerConfiguration) {
